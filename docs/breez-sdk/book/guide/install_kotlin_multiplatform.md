...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("technology.breez.spark:breez-sdk-spark-kmp:0.24.1")
        }
    }
}
```
...
```gradle
plugins {
    id("technology.breez.spark.kmp") version "0.24.1"
}
...
``` swift
.package(url: "https://github.com/breez/breez-sdk-spark-swift.git", from: "0.24.1"),
```
